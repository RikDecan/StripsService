        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StripEFId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Autheurs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Autheurs_Strips_StripEFId",
                        column: x => x.StripEFId,
                        principalTable: "Strips",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_Autheurs_StripEFId",
                table: "Autheurs",
                column: "StripEFId");
